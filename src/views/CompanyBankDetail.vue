        ...
        <div class="dropdown ml-auto sm:ml-0">
          ...
          <div class="dropdown-box w-40">
            <div class="dropdown-box__content box dark:bg-dark-1 p-2">
              ...
              >
                <i data-feather="plus-circle" class="w-4 h-4 mr-2" /> New {{name}}
              </a>
              <a
                class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"
              >
...
export default {
  ...
  computed: {
    ...mapState({
      company_bank_details: (state) => state.company_bank_detail.company_bank_details,
    }),
    ...mapGetters(["getCompanyBankDetails"]),
  },
  mounted() {
    this.fetchAllCompanyBankDetails().then(() => {
      let tableData = this.company_bank_details;  
