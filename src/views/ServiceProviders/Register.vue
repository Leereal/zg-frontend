          ...
          >
            ...
            <div class="intro-x mt-8">
              <div>
                ...
                <input
                  v-model.trim="$v.ahfoz_number.$model"
                  type="text"
                  class="input w-full border mt-2"
                  :class="{ 'border-theme-6': $v.ahfoz_number.$error }"
                  placeholder="ZG1-123456789"
                >
                <template v-if="$v.ahfoz_number.$error">
                  <div
                    v-if="!$v.ahfoz_number.required"
  ...
  methods: {
    save() {
      ...
      if (this.$v.$invalid) {
        ...
        this.$store
          .dispatch("register", { email: this.email, password: this.password, confirm_password: this.repeatPassword, ahfoz_number: this.ahfoz_number   })
          .then((res) => {
