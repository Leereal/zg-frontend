        ...
        <div class="dropdown ml-auto sm:ml-0">
          ...
          <div class="dropdown-box w-40">
            <div class="dropdown-box__content box dark:bg-dark-1 p-2">
              ...
              >
                <i data-feather="plus-circle" class="w-4 h-4 mr-2" /> New Bank Detail
              </a>
              <a
                class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"
              >
                <i data-feather="plus-circle" class="w-4 h-4 mr-2" /> New Claim
              </a>
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...mapState({
      sp_bank_details: (state) => state.sp_bank_detail.sp_bank_details,
    }),
    ...mapGetters(["getSpBankDetails"]),
  },
  mounted() {
    this.fetchAllSPBankDetails().then(() => {
      let tableData = this.sp_bank_details;  
      this.table = new Tabulator(this.$refs.table, {
        ...
        pagination: "local",
        paginationSize: 10,
        paginationSizeSelector: [30, 50, 100, 200, 1000, 5000],
        headerSort: true,
