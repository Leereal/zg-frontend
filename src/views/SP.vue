        ...
        <div class="dropdown ml-auto sm:ml-0">
          ...
          <div class="dropdown-box w-40">
            <div class="dropdown-box__content box dark:bg-dark-1 p-2">
              ...
              >
                <i data-feather="percent" class="w-4 h-4 mr-2" /> New Claim
              </a>
              <a
                class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"
              >
                <i data-feather="package" class="w-4 h-4 mr-2" /> New Service Provider
              </a>
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...mapState({
      service_providers: (state) => state.service_provider.service_providers,
    }),
    ...mapGetters(["getServiceProviders"]),
  },
  mounted() {
   
    this.fetchAllServiceProviders().then(() => {
      let tableData = this.service_providers;
  ...
  methods: {
    ...mapActions(["fetchAllServiceProviders", "addBranch", "deleteBank", "updateBranch"]),
    save() {
      if (this.edit == false) {
